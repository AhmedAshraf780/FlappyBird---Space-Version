...
struct Bird
{
	...
	void Atrributes()
	{
		player.loadFromFile("Assets/""bird1.png");
		...
		player2.loadFromFile("Assets/""bird6.png");
		...
		player3.loadFromFile("Assets/""bird5.png");
...
struct Pipe
{
	...
	Sprite PipeOftop[25], PipeOfbottom[25],Pipetopl2[40],Pipebottoml2[40],Pipebottoml3[60],Pipetopl3[60];
	void attributes()
	{
		Pipetp.loadFromFile("Assets/""pipe.png");
		Pipebm.loadFromFile("Assets/""coloumn.png");
		pipetpl2.loadFromFile("Assets/""top.png");
		pipebml2.loadFromFile("Assets/""colomnbottom_lvl2.png");
		pipebml3.loadFromFile("Assets/""columnbottom_lvl3.png");
		pipetpl3.loadFromFile("Assets/""columntop_lvl3.png");
		for (int i = 0; i < 25; i++)
		{
	...
	void setPositionl2() {
		...
		for (int i = 5; i < 10; i++)
		{
			Pipebottoml2[i].setPosition(Vector2f(1200 + (i * 350), Pipebottoml2[i - 1].getPosition().y + i * 10));
		}
		...
		for (int i = 20; i < 27; i++) {
			...
			Pipebottoml2[i].setPosition(Vector2f(1200 + (i * 350), Pipebottoml2[i - 1].getPosition().y + i * 3));
		}
		//Position of 27~33 pipes
		for (int i = 27; i < 33; i++) {
			Pipebottoml2[20].setPosition(Vector2f(1200 + (20 * 350), 290));
			Pipebottoml2[i].setPosition(Vector2f(1200 + (i * 350), Pipebottoml2[i - 1].getPosition().y - i * 2));
		}
		//Position of 33~40 pipes
		for (int i = 33; i < 40; i++) {
			Pipebottoml2[33].setPosition(Vector2f(1200 + (33 * 350), 680));
			Pipebottoml2[i].setPosition(Vector2f(Pipebottoml2[i - 1].getPosition().x + i * 5, 680));
		}
		...
		for (int i = 5; i < 10; i++)
		{
			Pipetopl2[i].setPosition(Vector2f(1200 + (i * 350), Pipetopl2[i - 1].getPosition().y + i * 10));
		...
		for (int i = 20; i < 27; i++)
		{
			...
			Pipetopl2[i].setPosition(Vector2f(1200 + (i * 350), Pipetopl2[i - 1].getPosition().y + i * 3));
		...
		{
			Pipetopl2[20].setPosition(Vector2f(1200 + (20 * 350), -239));
			Pipetopl2[i].setPosition(Vector2f(1200 + (i * 350), Pipetopl2[i - 1].getPosition().y - i * 2));
		...
		for (int i = 33; i < 40; i++) {
			...
			Pipetopl2[i].setPosition(Vector2f(Pipetopl2[i - 1].getPosition().x + i * 5, 151));
		}
	...
	void setPositionl3() {
		...
		for (int i = 5; i < 10; i++) {
			...
			Pipebottoml3[i].setPosition(Vector2f(Pipebottoml3[i - 1].getPosition().x + (i * 30), 510 - i * (8)));
			Pipebottoml3[5].setPosition(Vector2f(3000, 510));
			Pipebottoml3[8].setPosition(Vector2f(Pipebottoml3[7].getPosition().x + (8 * 30), 600 + 50));
			Pipebottoml3[9].setPosition(Vector2f(Pipebottoml3[8].getPosition().x + (9 * 30), 540));
			//TOP
			Pipetopl3[i].setPosition(Vector2f(Pipetopl3[i - 1].getPosition().x + (i * 30), 1 - i * (8)));
			Pipetopl3[5].setPosition(Vector2f(3000, 1));
			Pipetopl3[6].setPosition(Vector2f(3500, 1));
			Pipetopl3[8].setPosition(Vector2f(Pipetopl3[7].getPosition().x + (8 * 30), 70 + 50));
			Pipetopl3[9].setPosition(Vector2f(Pipetopl3[8].getPosition().x + (9 * 30), -41));

		}
		for (int i = 10; i < 15; i++) {
			//BOTTOM
			Pipebottoml3[i].setPosition(Vector2f(1200 + (i * 310) + 200, 580 - (i * 29)));
			Pipebottoml3[10].setPosition(Vector2f(1200 + (10 * 310) + 200, 610 - (10 * 29)));
			//TOP
			Pipetopl3[i].setPosition(Vector2f(1200 + (i * 310) + 200, 50 - (i * 29)));
			Pipetopl3[10].setPosition(Vector2f(1200 + (10 * 310) + 200, 80 - (10 * 29)));
		}
		for (int i = 15; i < 20; i++) {
			//BOTTOM
			Pipebottoml3[i].setPosition(Vector2f(1200 + (i * 310) + 150, 570 + (i * 20)));
			Pipebottoml3[15].setPosition(Vector2f(1200 + (15 * 310) + 200, 510 + 15 * 20));
			Pipebottoml3[19].setPosition(Vector2f(1200 + (19 * 310) + 200, 580 + 19 * 20));
			//TOP
			Pipetopl3[i].setPosition(Vector2f(1200 + (i * 310) + 150, 40 + (i * 20)));
			Pipetopl3[15].setPosition(Vector2f(1200 + (15 * 310) + 200, -20 + (15 * 20)));
			Pipetopl3[19].setPosition(Vector2f(1200 + (19 * 310) + 200, 50 + (19 * 20)));
		...
		//individual sequence
			...
			Pipebottoml3[46].setPosition(Vector2f(2300 + ((46) * 400), 880 - (46 - 30) * 30));
			...
			Pipetopl3[46].setPosition(Vector2f(2300 + ((46) * 400), 400 - (46 - 30) * 30));
		...
		{
			//Bottom
			Pipebottoml3[i].setPosition(Vector2f(2300 + ((i) * 400), 520 - (i - 30) * 60));
			//Top
		...
		{
			//Bottom
			Pipebottoml3[i].setPosition(Vector2f(2300 + ((i) * 400), 530 - (i - 30) * -30));
			//Top
			Pipetopl3[i].setPosition(Vector2f(2300 + ((i) * 400), 1 - (i - 30) * -30));
		...
		{
			//Bottom
			Pipebottoml3[i].setPosition(Vector2f(2300 + ((i) * 400), 880 - (i - 30) * 25));
			//Top												 
			Pipetopl3[i].setPosition(Vector2f(2300 + ((i) * 400), 400 - (i - 30) * 25));
		}
		for (int i = 51; i <= 56; i++)
		{
			//Bottom
			Pipebottoml3[i].setPosition(Vector2f(2300 + ((i) * 400), Pipebottoml3[i - 1].getPosition().y + (i - 30) * 3));
			//Top								  
			Pipetopl3[i].setPosition(Vector2f(2300 + ((i) * 400), Pipetopl3[i - 1].getPosition().y + (i - 30) * 3));
		}
	...
	void pipemovel3() {
		...
		for (int i = 0; i < 3; i++) {
			...
			Pipetopl3[2 * i + 1].setPosition(Vector2f(Pipetopl3[2 * i + 1].getPosition().x, Vib_top - i * 10));
			Pipebottoml3[2 * i + 1].setPosition(Vector2f(Pipebottoml3[2 * i + 1].getPosition().x, Vib_bottom - i * 10));
			Pipetopl3[20].setPosition(Vector2f(Pipetopl3[20].getPosition().x, Vib_top - i * 10));
			Pipebottoml3[20].setPosition(Vector2f(Pipebottoml3[20].getPosition().x, Vib_bottom - i * 10));
			Pipetopl3[26].setPosition(Vector2f(Pipetopl3[26].getPosition().x, Vib_top - i * 10));
			Pipebottoml3[26].setPosition(Vector2f(Pipebottoml3[26].getPosition().x, Vib_bottom - i * 10));
			Pipetopl3[28].setPosition(Vector2f(Pipetopl3[28].getPosition().x, Vib_top - i * 10));
			Pipebottoml3[28].setPosition(Vector2f(Pipebottoml3[28].getPosition().x, Vib_bottom - i * 10));
			...
			else if (Pipebottoml3[4].getPosition().x >= Pipebottoml3[6].getPosition().x - 100) {
...
struct bommm
{
	...
	void attributes()
	{
		Fire1.loadFromFile("Assets/""BOM.png");
	...
	void Fireworks()
	{
		...
		for (int i = 0; i < 20; i++)
		{
			fire1.loadFromFile("Assets/""bom1.png");
			...
			fire2.loadFromFile("Assets/""bom2.png");
	...
	void draw_Fireworks(RenderWindow& window)
	{
		window.draw(Btngan1);
	}
}   bomm1;
struct Flags
{
	...
	{
		f1.loadFromFile("Assets/""FLAG L11.png");
		flag1.setTexture(f1);
		flag1.setPosition(9200, 10);
	}
	void Attributes_flag2()
	{
		f2.loadFromFile("Assets/""FLAG L22.png");
		flag2.setTexture(f2);
		flag2.setPosition(15400, 10);
	}
	void Attributes_flag3()
	{
		f3.loadFromFile("Assets/""FLAG L3.png");
		flag3.setTexture(f3);
...
struct Alien
{
	...
	void Spaceship1()
	{
		...
		ship.loadFromFile("Assets/""Spaceship blue.png");
	...
	void Spaceship_2p()
	{
		ship1.loadFromFile("Assets/""Spaceship red.png");
		ship2.loadFromFile("Assets/""Spaceship white.png");
...
int count3 = 0;
int y = 0; // To change position of pipe in y to make random sequence (first player)
int y2 = 0;		 // To change position of pipe in y to make random sequence (two player)
...
bool lsa = false;  // check point on the first game that tell me player didn't press space yet
...
void opponent(RenderWindow& window, string& name); // taking the name of opponent (two player mode)
void modes(RenderWindow& window); // Function that have i needded to show,settexts,move up ,move down
void endlessmode(RenderWindow& window); // Function includes The one and two players needs
...
void showingoptions(RenderWindow& window); // when player press Escape  in easy level,he found( 3 options)
void showingoptionsl2(RenderWindow& window); // when player press Escape in medium level he found (3 options)
void showingoptionsl3(RenderWindow& window);
void Gameoverl3(RenderWindow& window);
void winningl3(RenderWindow& window);
void leaderboard(RenderWindow& window);   // saving the data that user input it in file and showing it in achievement option
void Gameoverl1(RenderWindow& window);   // here we showing 3options when player died and reset all The bird function to its usual condition (level 1)
void winningl1(RenderWindow& window);    // here we showing 3 options when player is winning and reset all bird "" "" "" 
...
void countingp1(RenderWindow& window);    // Function that showing the counting of 3,2,1,0 to first player
void countingp2(RenderWindow& window);	  // same but second player	
void updatePipes(vector<PiPe>& pipes, float& pipeOffset);      // Function that generates ,moves,drawing and delets pipes of endless mode
void updatePipespl(vector<PiPe>& pipespl, float& pipeOffset);      // Function that generates ,moves,drawing and delets pipes of endless mode
void updatePipespr(vector<PiPe>& pipespr, float& pipeOffset2);    // i used it to rewriting same function to two players mode
void controlingOn_game();  // Function that i used it to change speed of pipes ,difficulty ,etc
...
int main()
{
	...
	RenderWindow window(VideoMode(viewwidth, viewheight), "Flappy Bird",Style::Default,ContextSettings(0,0,8));
	...
	Texture  BackgroundMenu, map, gr, map2, gr2, tp1, gp1, sp, za, kora1,spacegr, spacegr2,lvl3,grl3,nos;
	Sprite Map[2], Map2[2], Gr[2], Gr2[2], Background, mapp1[2], groundp1[2], spark, zarzeer, Kora[2], spaceground[2], spaceground2[2], Grl3[2], maplvl3[2];
	//Font 
	...
	BackgroundMenu.loadFromFile("Assets/""copy 2.jpg"); 
	Background.setTexture(BackgroundMenu);

	// map of easy level 

	map.loadFromFile("Assets/""wp6956942.png");	
	for (int i = 0; i < 2; i++)
	{
		Map[i].setTexture(map);
		Map[i].setPosition(Vector2f(i * 1920, 0));
	}
	gr.loadFromFile("Assets/""ground2.png");
	for (int i = 0; i < 2; i++)
	{
		Gr[i].setTexture(gr);
	...
	map2.loadFromFile("Assets/""maplvl2.jpg");
	for (int i = 0; i < 2; i++)
	{
		Map2[i].setTexture(map2);
		Map2[i].setPosition(Vector2f(i * 1920, 0));
	}
	gr2.loadFromFile("Assets/""ground2_lvl2.jpg");
	for (int i = 0; i < 2; i++)
	{
	...
	lvl3.loadFromFile("Assets/""maplvl3.jpg");

	grl3.loadFromFile("Assets/""ground2_copy.png");
	for (int i = 0; i < 2; i++)
	{
	...
	tp1.loadFromFile("Assets/""koraardia.jpg");
	gp1.loadFromFile("Assets/""smallground.png");
	for (int i = 0; i < 2; i++)
	{
	...
	za.loadFromFile("Assets/""bg.jpg");
	zarzeer.setTexture(za);

	//Spark 

	sp.loadFromFile("Assets/""spark.png");
	spark.setTexture(sp);
	
	//Space Background

	kora1.loadFromFile("Assets/""spacexx.jpg");
	for (int i = 0; i < 2; i++)
	{
	...
	Sprite fasel;
	nos.loadFromFile("Assets/""bar.png");
	...
	pipeTexturebottom.loadFromFile("Assets/""bottomcol.jpg");
	pipeTexturetop.loadFromFile("Assets/""topcol.jpg");
	top2.loadFromFile("Assets/""spacetop.jpg");
	bottom2.loadFromFile("Assets/""spacebottom.jpg");
	...
	wing.loadFromFile("Assets/""sfx_wing.wav");
	Wing.setBuffer(wing);
	Wing.setVolume(20);
	death.loadFromFile("Assets/""sfx_die.wav");
	Death.setBuffer(death);
	points.loadFromFile("Assets/""sfx_point.wav");
	Points.setBuffer(points);
	countdown.loadFromFile("Assets/""countdown.mp3");
	Count.setBuffer(countdown);
	menusound.loadFromFile("Assets/""soundmenu.mp3");
	menus.setBuffer(menusound);
	menus.setVolume(120);
	menus.setLoop(true);
	Points.setVolume(50);
	clap.loadFromFile("Assets/""clapping.mp3");
	Clap.setBuffer(clap);
	s1.loadFromFile("Assets/""tmheed.wav");
	s2.loadFromFile("Assets/""enfgar.wav");
	S1.setBuffer(s1);
	S2.setBuffer(s2);
	SoundBuffer sps;
	sps.loadFromFile("Assets/""spaceshipsound.mp3");
	Sound spacesound(sps);
	SoundBuffer ph;
	ph.loadFromFile("Assets/""hehe.mp3");
	Sound phenix(ph);
	SoundBuffer ship1;
	ship1.loadFromFile("Assets/""newsoundofspace.wav");
	Sound Ship1(ship1);
	Ship1.setVolume(10);
	SoundBuffer bre;
	bre.loadFromFile("Assets/""fighting.mp3");
	Sound Br(bre);
	click.loadFromFile("Assets/""ButtonClick.wav");
	SoundBuffer tell;
	tell.loadFromFile("Assets/""storysound.mp3");
	Sound story(tell);
	...
	while (true)
	{
		 ...
		 if (pagenum == 3)
		{
			...
			while (window.isOpen())
			{
				...
				if (j < 25)    //tricky and solve infinte score after bird exceed the last pipe
				{
					if (Flappy.bird.getPosition().x > levelonepipes.PipeOfbottom[j].getPosition().x + 20)
					{
						Points.play();
						Flappy.score++;
						j++;
				...
				if (count >=1)
				{
					...
					while (r)
					{
						...
						{
							BirdIndex++;
							Flappy.bird.setScale(0.4+BirdIndex/150,0.4+ BirdIndex/150);
							Flappy.bird.rotate(20);
							Map[0].setPosition(0, 0);        //to prevent shifting the Picture of window
							if (c2.getElapsedTime().asSeconds()>2) // if he enters this condition it means that he finishs that rotating
							{
					...
					Flappy.birdVelocity = 0;         //important... to prevent the fasting falling in next game 
					Flappy.score = 0;      
					j = 0;        //To enter the condition of if(j<25) again 
					Flag.flag1.setPosition(9200, 10);
					BirdIndex = 0;      //reset the factor of the big scale in the rotation show
					break;       //break to moving to the page that user enter 
				}
					
				//winning

				if (Flappy.bird.getGlobalBounds().intersects(Flag.flag1.getGlobalBounds()))    //he is winning
				{
					winningl1(window);
				...
				for (int i = 0; i < 2; i++)     //moving the Map picture after picture and they repeat themselves .
				{
					Map[i].move(-2, 0);
				...
				string scorestring = to_string(Flappy.score);  // to trans from int to string                     `	
		 ...
		 if (pagenum == 4)
		{
			...
			while (window.isOpen())
			{
				...
				for (int i = 0; i < 40; i++)
				{
					if (Flappy.bird3.getGlobalBounds().intersects(level2.Pipetopl2[i].getGlobalBounds()) || Flappy.bird3.getGlobalBounds().intersects(level2.Pipebottoml2[i].getGlobalBounds()) || Flappy.bird3.getPosition().y >= 840)
						count++;
				}

				if (n < 40)  //tricky condition to stop increment score after it moves last pipe
				{
					if (Flappy.bird3.getPosition().x > level2.Pipebottoml2[n].getPosition().x + 20)
					{
						Points.play();
						Flappy.score++;
						n++;
				...
				if (count >= 1)
				{
					...
					while (r)
					{
						...
						{
							BirdIndex++;
							Flappy.bird3.setScale(0.4 + BirdIndex / 150, 0.4 + BirdIndex / 150);
				...
				if (Flappy.bird.getGlobalBounds().intersects(Flag.flag2.getGlobalBounds()))
				{
					winningl2(window);
					Map2[0].setPosition(0, 0);
					Map2[1].setPosition(1920, 0);
		...
		{	
			...
			while (window.isOpen())
			{
				...
				for (int i = 0; i < 60; i++)
				{
					if (Flappy.bird2.getGlobalBounds().intersects(level3.Pipetopl3[i].getGlobalBounds()) || Flappy.bird2.getGlobalBounds().intersects(level3.Pipebottoml3[i].getGlobalBounds()) || Flappy.bird2.getPosition().y >= 840)
						count++;
				}

				if (f < 60)  
				{
					if (Flappy.bird2.getPosition().x > level3.Pipebottoml3[f].getPosition().x + 20)
					{
						Points.play();
						Flappy.score++;
						f++;
				...
				if (count >= 1)
				{
					...
					while (r)
					{
						...
						{
							BirdIndex++;
							Flappy.bird2.setScale(0.4 + BirdIndex / 150, 0.4 + BirdIndex / 150);
				...
				if (Flappy.bird2.getGlobalBounds().intersects(Flag.flag3.getGlobalBounds()))
				{
					winningl3(window);
					maplvl3[0].setPosition(0, 0);
					maplvl3[1].setPosition(1920, 0);
		 ...
		 if (pagenum == 8)
		{
				...
				while (window.isOpen())
				{
					...
					while (window.pollEvent(event))
					{
						...
						if (event.type == sf::Event::KeyPressed && event.key.code == sf::Keyboard::Up && monster.Spaceship.getPosition().y >= 40)
						{
							Ship1.play();
					...
					spaceship10.spaceship_move();  //The combination of Rectangles that fit the collision
					...
					for (auto &pipe:pipes) {
						for (int M = 0; M < 6; M++)
						{
							if (spaceship10.b[M].getGlobalBounds().intersects(pipe.topPipe.getGlobalBounds()) || spaceship10.b[M].getGlobalBounds().intersects(pipe.bottomPipe.getGlobalBounds()) ||spaceship10. b[M].getPosition().y >= 840)
							{
								count3++;
							}
						}
						...
						for (auto&pipe:pipes) {
							if (!pipe.passed&& pipe.topPipe.getPosition().x <monster.Spaceship.getPosition().x) {
					...
					if (count3 >= 1)    
					{
						...
						while (r)
						{
							...
							{
								BirdIndex++;
								monster.Spaceship.setScale(0.4 + BirdIndex / 150, 0.4 + BirdIndex / 150);
						...
						offile << Flappy.name << "              " << Flappy.score<< "                " << " EndLess " << " * " << endl;
				...
				/*	for (int i = 0; i < 2; i++)
					{
						...
						{
							spaceground2[i].setPosition(Vector2f(1400, 850));
						}
					}*/
			...
			while (window.isOpen())
			{
				...
				while (window.pollEvent(Ev))
				{
					if (Ev.type == Event::Closed)
						window.close();
					if (Ev.type == sf::Event::KeyPressed && Ev.key.code == sf::Keyboard::Space && monster.spaceship[0].getPosition().y >= 40)
					{
						Ship1.play();
						Flappy.birdVelocity = -5.5; // Jump
					}
					if (Ev.type == sf::Event::KeyPressed && Ev.key.code == sf::Keyboard::Up && monster.spaceship[1].getPosition().y >= 40)
					{
						Ship1.play();
				...
				for ( auto& pipe : pipespr)    //collision with combination of rects   (right player)
				{
						for (int M = 0; M < 5; M++)
						{
							if (spaceship10.b2[M].getGlobalBounds().intersects(pipe.topPipe.getGlobalBounds()) || spaceship10.b2[M].getGlobalBounds().intersects(pipe.bottomPipe.getGlobalBounds()) || spaceship10.b2[M].getPosition().y >= 1000)
							{
								count++;
								leftplayerwin = true;
							}
				...
				{
					if (!pipe.passed && pipe.topPipe.getPosition().x < monster.spaceship[1].getPosition().x) {
						pipe.passed = true; 
						Flappy.score++;
					}
				}
				for ( auto& pipe : pipespl)    //collision with combination of rects (left player)
				{
					for (int M = 0; M < 5; M++)
					{
						if (spaceship10.b1[M].getGlobalBounds().intersects(pipe.topp2.getGlobalBounds()) || spaceship10.b1[M].getGlobalBounds().intersects(pipe.bottomp2.getGlobalBounds())||spaceship10.b1[M].getPosition().y>=1000)
						{
							count2++;
							rightplayerwin = true;
						}
				...
				{
					if (!pipe.passed && pipe.topp2.getPosition().x < monster.spaceship[0].getPosition().x) {
						pipe.passed = true;
						Flappy.score++;
					}
				}
				...
				if (count >= 1)  //collision of right player
				{
					...
					while (r)
					{
						...
						{
							BirdIndex++;
							monster.spaceship[1].setScale(0.4 + BirdIndex / 150, 0.4 + BirdIndex / 150);
				...
				if (count2 >= 1)  
				{
					...
					while (r)
					{
						...
						{
							BirdIndex++;
							monster.spaceship[0].setScale(0.4 + BirdIndex / 150, 0.4 + BirdIndex / 150);
...
{
	Texture backg;
	backg.loadFromFile("Assets/""spacebackground.jpg");
	Sprite back;
...
{
	Font font2;
	font2.loadFromFile("Assets/""Roboto-BoldCondensed.ttf");
	Text t1, t2, t3;
	t1.setString("#free");
...
void showingoptionsl2(RenderWindow& window)
{
		...
		ShowingOptions sh(900, 1000);
		Texture t;
		t.loadFromFile("Assets/""maplvl2.jpg");
		Sprite tp(t);
		while (window.isOpen())
		{
			window.clear();
...
void showingoptionsl3(RenderWindow& window)
{
	ShowingOptions sh(900, 1000);
	Texture t;
	t.loadFromFile("Assets/""maplvl3.jpg");
	Sprite tp(t);
	while (window.isOpen())
	{
		window.clear();
...
void leaderboard(RenderWindow& window)
{
	...
	Texture t2;
	t2.loadFromFile("Assets/""copy 2.jpg");
	Sprite sp(t2);
	sp.setPosition(0, 0);
...
void winningl1(RenderWindow &window)
{
	...
	GameOver game1(900, 1000);
	Texture BackgroundMenu;
	BackgroundMenu.loadFromFile("Assets/""wp6956942.png");
	Sprite Background;
	Background.setTexture(BackgroundMenu);
	while (window.isOpen())
	{
...
void Gameoverl2(RenderWindow& window)
{
		...
		GameOver game1(900, 1000);
		Texture map;
		map.loadFromFile("Assets/""maplvl2.jpg");
		Sprite sp(map);
		while (window.isOpen())
		{
...
void winningl2(RenderWindow& window)
{
		...
		GameOver game1(900, 1000);
		Texture BackgroundMenu;
		BackgroundMenu.loadFromFile("Assets/""maplvl2.jpg");
		Sprite Background;
		Background.setTexture(BackgroundMenu);
		while (window.isOpen())
		{
...
void Gameoverl3(RenderWindow& window)
{
	Modes m(900, 1000);
	Texture backg;
	backg.loadFromFile("Assets/""maplvl3.jpg");
	Sprite back;
	back.setTexture(backg);
	while (window.isOpen())
	{
...
void modes(RenderWindow& window)
{
	Modes m(900,1000);
	Texture backg;
	backg.loadFromFile("Assets/""copy 2.jpg");
	Sprite back;
	back.setTexture(backg);
	while (window.isOpen())
	{
...
void Gameoveronep(RenderWindow& window)
{
		...
		Texture BackgroundMenu;
		BackgroundMenu.loadFromFile("Assets/""spacexx.jpg");
		Sprite Background;
		Background.setTexture(BackgroundMenu);
		while (window.isOpen())
		{
...
void Gameovertwop(RenderWindow& window)
{
	...
	Texture BackgroundMenu;
	BackgroundMenu.loadFromFile("Assets/""koraardia.jpg");
	Sprite Background;
	Background.setTexture(BackgroundMenu);
	while (window.isOpen())
	{
...
void Myteam(RenderWindow& window)
{
	...
	t1.loadFromFile("Assets/""alaa.jpg");
	t2.loadFromFile("Assets/""ashraf 2.jpg");
	t3.loadFromFile("Assets/""hamdy.jpg");
	t4.loadFromFile("Assets/""ibrahim 2.jpg");
	t5.loadFromFile("Assets/""bassam.jpg");
	t6.loadFromFile("Assets/""hossam.jpg");
	t7.loadFromFile("Assets/""khaled.jpg");
	Sprite Alaa(t1), Ashraf(t2), Hamdy(t3), Khaled(t7), Hema(t4), Hossam(t6), Bassam(t5);
...
void Instructions(RenderWindow& window)
{
	...
	t1.loadFromFile("Assets/""ins1.jpg");
	t2.loadFromFile("Assets/""inst2.jpg");
	t3.loadFromFile("Assets/""inst3.jpg");
	t4.loadFromFile("Assets/""multi.jpg");
	t5.loadFromFile("Assets/""Escape.jpg");
	t6.loadFromFile("Assets/""Bugs.jpg");
